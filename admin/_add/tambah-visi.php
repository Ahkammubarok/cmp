            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        ...
                        <li class="breadcrumb-item"><a href="../sejarah.php">Visi</a></li>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="judul_visi" name="judul_visi" placeholder="Judul Visi..." required>
                                    </div>
                                    <div class="form-group">
                                        <label for="isi_visi" class="form-label">Isi Visi</label>
                                        <textarea name="isi_visi" id="isi_visi"></textarea>
                                    </div>
                                </div>
